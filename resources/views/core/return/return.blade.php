...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">RETURN ITEM</h4>
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                        <h6><strong style="color:#000000;">RENTAL DETAILS</strong></h6>
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap text-left" style="background-color:#ffffff;border-collapse: collapse; border-spacing: 0; width: 100%;">
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td style="color:#000000">
                                    <img src="{{$rental_data->nic_image}}" width="auto" height="100"/>
                                </td>
                                <td>
                                    <a style="color:#ff0000;" href="{{$rental_data->nic_image}}" target="_blank">View Photo Larger</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" method="GET" action="/return_item_final" enctype="multipart/form-data">
                        @csrf
                           <input type="hidden" value="{{$rental_data->rental_id}}" name="rental_id"/>
                           <div class="form-group">
                                ...
                                <input
                                    ...
                                    disabled
                                    type="text"
                                    value="{{$rental_data->product_price}}"
                                autofocus>
                                <label for="purchase_amount">DISCOUNT AMOUNT | LKR</label>
                                <input
                                    disabled
                                    style="text-align:right"
                                    class="form-control @error('date') is-invalid @enderror"
                            ...
                            <div class="mt-4">
                                <button style="color:#ffffff;" class="btn btn-primary btn-block waves-effect waves-light" type="submit">RETURN ITEM</button>
                            </div>
                    </form>
                </div>
            </div>
