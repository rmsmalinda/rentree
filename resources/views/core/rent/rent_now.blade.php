  ...
  function addDiscount()
  {
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                                <form class="form-horizontal" method="POST" action="/rent_now_final" enctype="multipart/form-data">
                                        @csrf
                                           ...
                                           <div class="form-group">
                                                <label for="product_code">RENTAL DATE</label>
                                                <input
                                                    disabled
                                                    type="text"
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="mt-4">
                                                <button style="color:#000000;" class="btn btn-success btn-block waves-effect waves-light" type="submit">RENT NOW</button>
                                            </div>
                                    </form>
